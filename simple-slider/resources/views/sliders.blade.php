...
@if (count($sliders) > 0)
    ...
    @if($mobile_hidden =='1'){{ 'd-none d-md-block' }} @endif
    @if($desktop_hidden =='1'){{ 'd-block d-md-none' }} @endif
    " data-owl-auto="true" data-owl-loop="true" data-owl-speed="7000"
         data-owl-gap="0" data-owl-nav="false" data-owl-dots="true"
         data-owl-item="1" data-owl-item-xs="1"
         data-owl-item-sm="1" data-owl-item-md="1"
         data-owl-item-lg="1" data-owl-duration="1000"
